...
contract LearnToEarn {
    ...
    function register() external payable {
        ...
        cohort.push(Student(msg.sender, block.timestamp, msg.value, 0, false));
         // deploy learn token address
        ILearnToken(0xefbF2Cc7f87aA9034a9a4Ac97c2dd1b325B3c2f7).mint(msg.sender, msg.value * 2);
    ...
    function ping() external {
        ...
        // deploy learn token address
        ILearnToken(0xefbF2Cc7f87aA9034a9a4Ac97c2dd1b325B3c2f7).mint(msg.sender, 1);
    }
